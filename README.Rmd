...
In addition, to overcome the tedious steps of programming and make it friendly for ordinary users, we developed an interactive application based on Shiny. Users only need to use the command `oncoClassSurv_RunShiny()` to visit it.
